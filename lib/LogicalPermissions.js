...
var LogicalPermissions = function LogicalPermissions() {
  ...
  */
   ...
   * @param {Function} callback - The callback that evaluates access bypassing.
   */
  ...
  this.checkAccess = function checkAccess(permissions, context) {
    ...
    if(permissions_copy.hasOwnProperty('no_bypass')) {
      ...
      if(variable_type === 'Boolean') {
        ...
        throw {name: 'InvalidArgumentValueException', message: 'The no_bypass value must be a boolean or an object. Current value: ' + JSON.stringify(permissions.no_bypass)};
      }
