...
var LogicalPermissions = function LogicalPermissions() {
  ...
  */
   ...
   * @param {Object|Array} permissions - The permission tree to be evaluated
  ...
  this.checkAccess = function checkAccess(permissions, context, allow_bypass) {
    ...
    if(getVariableType(permissions) !== 'Object' && getVariableType(permissions) !== 'Array') {
      throw {name: 'InvalidArgumentTypeException', message: 'The permissions parameter must be an object or an array.'};
    }
    ...
    if(getVariableType(permissions) === 'Object' && permissions_copy.hasOwnProperty('no_bypass')) {
      if(allow_bypass) {
